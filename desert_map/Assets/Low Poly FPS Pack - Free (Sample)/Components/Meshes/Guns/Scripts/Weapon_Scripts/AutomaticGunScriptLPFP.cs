...
public class AutomaticGunScriptLPFP : MonoBehaviour
{
	...
	[Header("UI Weapon Name")] [Tooltip("Name of the current weapon, shown in the game UI.")]
	...
	[Header("Grenade Settings")] public float grenadeSpawnDelay = 0.35f;

	[Header("Muzzleflash Settings")] public bool randomMuzzleflash = false;
	...
	[Header("UI Components")] public Text timescaleText;
	...
	{
		[Header("Prefabs")] public Transform bulletPrefab;
